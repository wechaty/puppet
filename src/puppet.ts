...
export abstract class Puppet extends PuppetEventEmitter {
  ...
  public abstract async contactCorpRemark (contactId: string, corpRemark: string): Promise<void>

  public abstract async contactDesc (contactId: string, desc: string): Promise<void>
